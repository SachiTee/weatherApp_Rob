...
//
//     toFahrenheit() {
//         var degK = this.weatherDay.temp.day;
//         return Math.round((1.8 * (degK - 273)) + 32);
//     }
//
//     toDate() {
//         var dt = this.weatherDay.dt;
...
function weatherResultComponent() {
    ...
    ctrl.dateFormat = 'MMM d, y';

    ctrl.toFahrenheit = function() {
        var degK = ctrl.weatherDay.temp.day;
        console.log(degK);

        return Math.round((1.8 * (degK - 273)) + 32);
    }

    ctrl.toDate = function() {
        var dt = ctrl.weatherDay.dt;
        return new Date(dt * 1000);
    }
